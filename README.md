...
`com.ekumar.cydamseru.BACKUP`. This will work even when Auto Backup is
disabled.
...
##<a name="credits">Credits</a>
  ...
  * JoÃ£o Pedro Ferreira - Portugese translation
  * Martijn Brouns - Dutch translation
  * [Tobeon](http://tobeon.net) - Norwegian translation
  * Nemanja BraÄ�ko - Serbian translation
...
[MarketQRCode]: http://chart.apis.google.com/chart?cht=qr&chs=100x100&chl=https://play.google.com/store/apps/details?id=com.ekumar.cydamseru
[MarketLink]: https://play.google.com/store/apps/details?id=com.ekumar.cydamseru
